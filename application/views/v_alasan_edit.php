			<main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Ubah Alasan</li>
                        </ol>
                        <div class="card mb-4">
							...
							<div class="card-body">
					<?php 
					if(isset($_POST['kd_alasan_eksis'])==1){
					...
					<?php 
							...
							$kd_alasan = $tbl_alasan->kd_alasan;
							$detail_alasan = $tbl_alasan->detail_alasan;
					}?>
					
				  <?php echo form_open_multipart("alasan/alasan_aksi_ubah"); ?>
					<input type="hidden" name="id_alasan" value="<?php echo $tbl_alasan->id_alasan;?>" required>
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="hidden" name="kd_alasan[]" value="<?php echo $tbl_alasan->kd_alasan;?>" >
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
