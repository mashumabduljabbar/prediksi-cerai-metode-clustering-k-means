			<main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Tambah Umur Perkawinan</li>
                        </ol>
                        <div class="card mb-4">
							...
							<div class="card-body">
					<?php 
					if($_POST['kd_umurperkawinan_eksis']==1){
					...
					<?php 
							...
							$kd_umurperkawinan = "";
							$nilai_umurperkawinan = "";
					}?>
					
				  <?php echo form_open_multipart("umurperkawinan/umurperkawinan_aksi_tambah"); ?>
					<div class="col-md-6">
